...
st.set_page_config(
    page_title="GenAI Resume Copilot (Prototype)", 
    layout="wide"
)

st.sidebar.title("GenAI Resume Copilot")
page = st.sidebar.radio("Go To", ["⚙️ Resume Copilot", "📌 JD Comparator"])
...
# =====
# Page 1: Resume Copilot
# =====
if page == "⚙️ Resume Copilot":
    st.title("📄 GenAI Resume Copilot")
...
# ======
# Page 2: JD Comparator
# ======
if page == "📌 JD Comparator":
    st.title("📌 Gen AI JD Comparator (using RAG)")
